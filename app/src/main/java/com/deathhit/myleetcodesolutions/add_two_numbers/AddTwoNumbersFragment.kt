...
class AddTwoNumbersFragment : StateFragment<AddTwoNumbersViewModel.State, AddTwoNumbersViewModel>() {
    companion object {
    ...
    override fun createViewModel(args: Bundle): AddTwoNumbersViewModel {
        val viewModelAdd: AddTwoNumbersViewModel by viewModels()
        return viewModelAdd
    }
